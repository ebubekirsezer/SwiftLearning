 ...
 class FBSharer: Sharing {
    func post(message: String) -> Bool {
        print("Message \(message) posted on Facebook")
        return true
    }
 }
 ...
 class TwitterSharer: Sharing {
    func post(message: String) -> Bool {
        print("Message \(message) posted on Twitter")
        return true
    }
 }
...
// }
 ...
 public class Sharer {
    ...
    private let services: [Platform: Sharing] = [.facebook: FBSharer(), .twitter: TwitterSharer(), .reddit: RedditPoster()]
